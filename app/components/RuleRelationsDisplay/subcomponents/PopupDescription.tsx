...
export function PopupDescription({ data, onClose, visible }: PopupDescriptionProps) {
  ...
  return (
    <div className={styles.popupContainer} role="dialog" aria-label="Rule details" onKeyDown={handleKeyDown}>
      ...
      <Popover content={!data.isPublished ? "Rules in draft are not added to Klamm" : null} trigger="hover">
        <Button
          type="link"
          className={styles.link}
